...
<!-- 
 <img src="pict/blue.jpg" alt="Paris" width="400" height="300"> -->
      <a href="#logo" data-toggle="collapse">
        <img src="pict/cocoa.png" alt="Random Name" width="200" height="50">
      </a>
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown">
          ...
          <li><a <a href="login.php">MASUK</a></li>
 ...
 -->
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img src="pict/13.jpg" alt=" ----  " width="1200" height="700">
      <p>----</p>
      </div>

      <div class="item">
        <img src="pict/14.jpg" alt=" ---- " width="1200" height="700">
      ...
      <div class="item">
        <img src="pict/12.jpg" alt=" --- " width="1200" height="700">
        <div class="carousel-caption">
      ...
      <div class="item">
        <img src="pict/11.jpg" alt=" --- " width="1200" height="700">
        <div class="carousel-caption">
