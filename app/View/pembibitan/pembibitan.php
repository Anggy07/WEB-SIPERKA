    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Masukan Data Pembibitan</h4>
            </div>
                ...
                <div class="modal-body">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" placeholder="Enter bibit" data-rule-maxlength="250" required="1" name="tgl_pembibitan" type="date" value="">
                        </div>
                        <div class="row">
                            <div class="form-group col-md-12">
                                <label for="tambahan"> Nama Tanaman </label>
                                <select class="form-control"  name="nama_tanaman">
                        ...
                        <div class="row">
                            <div class="form-group col-md-12">
                                ...
                                <select class="form-control"  name="nama_lahan">
