    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav link-effect">
                ...
                <li class="active"><a> Edit Tanaman</a></li>
            </ul>
        </div>
    </div>
</nav>
...
<form class="form-horizontal" action="index.php?id=<?=$row[0]?>" method="POST">
    ...
    <fieldset>
        <legend>Data Tanaman</legend>
        <div class="form-row">
            <div class="form-group">

                <div class="form-group">
                    <label for="customerName">Nama Tanaman :(wajib diisi)</label>
                    <input class="form-control" placeholder="Enter tanaman" data-rule-maxlength="250" required="1" name="nama_tanaman" type="text" value="<?=$row[1]?>">
                </div>
                <div class="form-group">
                    <label for="customerName">Jenis Tanaman :(wajib diisi)</label>
                    <input class="form-control" placeholder="Enter jenis" data-rule-maxlength="250" required="1" name="jenis_tanaman" type="text" value="<?=$row[2]?>">
                </div>

                <div class="form-group">
                    <label for="phoneNumber">Periode Tanam :(bulan)</label>
                    <input class="form-control" placeholder="Enter periode" data-rule-minlength="10" data-rule-maxlength="13" required="1" name="periode_tanaman" type="text" value="<?=$row[3]?>">
                </div>
        </div>
