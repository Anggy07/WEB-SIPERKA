    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav link-effect">
                ...
                <?php } ?>
                <li class="dropdown">
                    <a href="#" class="active" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"> Data <span class="caret"></span></a>
      ...
      <td > $row[5] </td >";
        ...
        <a href = 'edit/?id=$row[0]' ><img src = '../../gambar/edit.png' ></a >";
                if ($_SESSION['level'] == 0) {
                    ...
                    echo "<a href = 'delete.php?id=$row[0]' onclick='return confirm(\"Apakah anda ingin menghapus user dengan id $row[0]\";'><img src = '../../gambar/delete.png' ></a >";
                }
            }
            echo "</tr>";
//    }
...
<?php if($_SESSION['level'] == 0) { ?>
    <a href="" class="btn btn-success" data-toggle="modal" data-target="#AddModalBaru">Tambah</a>
<?php } ?>
</div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Masukan Data Pemupukan</h4>
            </div>
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            <div class="form-group col-md-12">
                                ...
                                <select class="form-control"  name="id_pembibitan">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" placeholder="Enter pemupukan" data-rule-maxlength="250" required="1" name="tgl_pemupukan" type="date" value="">
                        </div>

                        <div class="row">
                            <div class="form-group col-md-12">
                                <label for="tambahan"> Nama Pupuk </label>
                                <select class="form-control" id="jabatan" name="nama_pupuk">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" placeholder="Enter volume" data-rule-maxlength="250" required="1" name="vol_pupuk" type="text" value="">
                        </div>

                        <?php if($_SESSION['level'] == 1) { ?>
                            <div class="form-group">
                                <label for="phoneNumber">Status :(wajib diisi)</label>
                                <input class="form-control" placeholder="Enter status" data-rule-minlength="10" data-rule-maxlength="13" required="1" name="status" type="text" value="">
                            </div>
                        <?php } ?>
