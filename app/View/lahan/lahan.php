    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Masukan Data Lahan</h4>
            </div>
                ...
                <div class="modal-body">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" placeholder="Enter lahan" data-rule-maxlength="250" required="1" name="nama_lahan" type="text" value="">
                        </div>
                        <div class="form-group">
                            <label for="customerName">Luas Lahan :(wajib diisi)</label>
                            <input class="form-control" placeholder="Enter luas" data-rule-maxlength="250" required="1" name="luas_lahan" type="text" value="">
                        </div>

                        <div class="form-group">
                            <label for="phoneNumber">Ph Tanah :(wajib diisi)</label>
                            <input class="form-control" placeholder="Enter ph" data-rule-minlength="10" data-rule-maxlength="13" required="1" name="ph_tanah" type="text" value="">
                        </div>
